<template>
  <div style="background: #fff">
    ...
    <!-- 商品信息展示 -->
    <ShopInfo @handleClickSku="targetClickSku" v-if="shopsMsg" :detail="shopsMsg"></ShopInfo>
    <!-- 商品详细展示 -->
    <CommentBody v-if="shopsMsg" :detail="shopsMsg"></CommentBody>
...
import ShopInfo from "@/components/shopComment/ShopInfo";
import CommentBody from "@/components/shopComment/CommentBody";
