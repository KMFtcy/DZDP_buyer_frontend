          ...
          <div class="remarks-container" ref="itemGoodsComment">
            ...
            <div class="review-body">
              ...
              <!-- <div class="upload-image-module">
                <div class="module-title">图片/视频</div>
                <div class="upload-wrapper">
                  <div class="upload-info">
                    <div class="upload-module"><input type="file" multiple="" name="上传图片" accept="image/*" value=""
                        class="upload-image"><button
                        class="btn btn-1 btn-upload btn-image-upload"><span>上传图片</span></button>
                    </div>
                    <div class="upload-desc">单张图片不超过10MB，尺寸不小于300*300px，支持jpg、png和bmp格式</div>
                  </div>
                  <div class="pic-wrapper"></div><button class="btn btn-1 btn-upload"><span>上传视频</span></button>
                </div>
              </div> -->
